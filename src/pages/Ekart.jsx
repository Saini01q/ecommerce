...
import { handleremoveitem, handleIncreaseItem, handledecreaseItem } from '../redux/product.slice';

function Ekart() {

  const { addedproducts, totalprice } = useSelector(
  ...
  return (
    <div>
      {addedproducts && addedproducts.length > 0 ?
        <div className="container mx-auto px-4 py-8 bg-gray-950 text-gray-50">
          {/* Header */}
                    ...
                    <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border-b border-gray-700">
                      ...
                      <div className="md:col-span-2 flex md:block items-center">
                        ...
                        <div className="flex items-center justify-center">
                          <button  onClick={() => Dispatch(handledecreaseItem(res.id))} className="text-gray-400 hover:text-white p-1">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5"
                              viewBox="0 0 20 20"
                          ...
                          />
                          <button onClick={() => Dispatch(handleIncreaseItem(res.id))} className="text-gray-400 hover:text-white p-1">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5"
                              viewBox="0 0 20 20"
                      ...
                      <div className="md:col-span-2 flex md:block items-center">
                        ...
                        <div className="text-center font-medium">${(res.price * res.quantity).toFixed(2)}</div>
                      </div>
                      <div className="md:col-span-1 flex justify-end">
                        <button onClick={() => Dispatch(handleremoveitem(res.id))} className="text-gray-400 hover:text-red-500">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5"
                            viewBox="0 0 20 20"
              ...
              <div className="bg-gray-800 rounded-lg shadow-lg p-6 sticky top-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between border-t border-gray-700 pt-4">
                    ...
                    <span className="font-bold text-xl">${(totalprice + 14).toFixed(2)}</span>
                  </div>
                </div>
        ...
        </div> : <center className='p-28'>
          <h1>NO ITEMS AVIALABLE</h1>
          <NavLink to='/'>Continue Shopping</NavLink>
          <img className="w-100" src="https://tse1.mm.bing.net/th?id=OIP.4crNXDhePHX2pSGwWXC7wwAAAA&pid=Api&P=0&h=180"></img></center>}
    </div>
  )
